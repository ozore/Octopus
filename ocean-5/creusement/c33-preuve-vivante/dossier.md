# Dossier de creusement : Preuve Vivante

Date : 7 septembre 2026. Échelle reçue (dossier de tendance, section f, échelle 1) : un service qui
transforme les photos et vidéos de plongée déjà prises par les équipes de suivi en preuve de survie
...
Aucun acteur trouvé ne vend un service commercial de comptage de survie par vision par ordinateur,
...
Le port de Tampa Bay est un acheteur public, exclu par les interdits du fondateur (pas de marché public
comme premier client). Recherche de remplacement par trois entreprises privées, dans les trois catégories
...
Question 8, en année cinq plus difficile à attaquer qu'en année un : oui, si le nombre de sites sous
obligation pluriannuelle atteint une masse critique (dizaines de sites, deux cadres réglementaires).
...
Objectif chiffré : démontrer, sur un jeu de photos publiques de quadrats d'huîtres ou de zostère, un
comptage automatisé qui concorde avec un comptage humain publié à au moins 85% (écart maximal de 15%),
sur au moins 50 images test, sans contacter aucun sponsor ni cabinet.
