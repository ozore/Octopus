...
| BACKLOG.md + specs/ | Product Owner agent | pending |
| KNOWLEDGE_BASE.md | Product Owner agent | pending |
| OFFER.md | Offer & Landing agent | pending |
| LANDING_SPEC.md | Offer & Landing agent | pending |
| REVIEW.md | Reviewer agent (wave 1b) | pending |
| THRESHOLDS.md | Product Owner agent | pending |
