...
## WebFetch (libre) — résultats
- WGCU/floridatrib (coupure FCR3 2026) -> SUCCES MAJEUR. Chiffres détaillés: 28,5M$ distribués à 14 orgs depuis 2023; 25M$ attendus 2026 (non obtenus); 0$ alloué 2026; coupe globale état 800M$ sur budget 117,6Md$. Orgs nommées avec montants individuels (Plant A Million Corals 950k$, I.CARE 585k$, Reef Institute 3,5M$, Reef Renewal USA 2M$).
- Federal Register FKNMS blueprint (direct) -> ECHEC (redirect vers unblock.federalregister.gov, non suivi). Contournement: floridakeys.noaa.gov/blueprint/faqs.html -> SUCCES partiel (période d'attente 45j + révision gouverneur; ancrage interdit SPA d'ici 2027; notif 24h/retrait 72h échouement; permis appâts éliminés sur 3 ans; expansion limite +20% alignée sur "Area to Be Avoided" 1997).
- flsenate.gov statut 403.93345 -> SUCCES EXCELLENT. Barème pénalités civiles précis par tranche de m² avec majorations (agravantes, localisation) et multiplicateurs récidive (x2/x3/x4), plafond 250 000$/incident.
- GAO PDF (gao.gov) -> ECHEC WebFetch direct (PDF binaire non lisible par le résumeur), CONTOURNEMENT: pip install pymupdf + lecture directe du PDF sauvegardé -> SUCCES EXCELLENT. CRCA reautorisée déc 2022 (NDAA FY23 / James M. Inhofe NDAA, PL 117-263) autorise 45M$/an FY23-27 (vs ~33M$/an FY21-23 réellement appropriés). 7 juridictions (FL, HI, PR, USVI, Guam, American Samoa, CNMI). 4 line offices/12 program offices NOAA. GAO-24-106692 publié 13/02/2024, recommande meilleur suivi des dépenses.
- NOAA CRCP FY2024 grants PDF -> via pymupdf -> SUCCES EXCELLENT. FY24: ~9M$ nouvelles subventions + 3M$ leviers non-fédéraux = 12M$ impact total, 6 opportunités de financement. State/Territorial Cooperative Agreements FY24: 4 626 862$ (+680 041$ match). Transition FY25 vers block grants non compétitifs. Exemple réponse espèce invasive (octocorail Xeniidae) Porto Rico: 159 084$, 212 m² traités.
- DEP Strategic Plan 2024-2029 PDF -> via pymupdf -> SUCCES EXCELLENT. FCR = 350 miles (Dry Tortugas à St Lucie Inlet), seul récif barrière des USA continentaux, 40+ espèces coraux bâtisseurs, économie touristique 6 milliards$, 71 000 emplois locaux, protection anti-inondation 675M$/an (jusqu'à >1Md$ lors tempêtes sévères) (USGS Storlazzi et al. 2019).
- myfwc.com SCTLD overview -> SUCCES EXCELLENT. Maladie affecte ~90% du récif floridien (>109 700 acres), près de la moitié des 45 espèces de coraux durs de Floride touchées (>20/45 espèces sensibles), mortalité jusqu'à 100% en semaines/mois. Chronologie: automne 2014 (Virginia Key Miami) -> 2017 (Martin County) -> mai 2021 (Dry Tortugas NP).
- Earthjustice Port Everglades -> SUCCES. Procès déposé 6 août 2026, dragage suspendu juillet 2025, reprise prévue automne 2026, espèces concernées staghorn/elkhorn/queen conch, panache sédimentaire sur des milliers de mètres.
- fisheries.noaa.gov critical habitat elkhorn/staghorn -> SUCCES partiel (doc 2008 seulement: 2959 sq mi total FL+PR+STT/STJ+STX, exclusion site militaire 5,5 sq mi).
- opc.ca.gov (2 tentatives) -> ECHEC (page rejetée par pare-feu/WAF, "Request Rejected"). Leçon: opc.ca.gov semble bloqué pour WebFetch, se contenter des données de la recherche web (5,94M$ kelp, 2,25M$ adaptive management 2023-2025).
- floridakeys.noaa.gov/coral-disease -> SUCCES partiel (carte 2014-2020, peu de chiffres agrégés -> chiffres tirés de myfwc.com à la place).

LEÇON GENERALE: WebFetch échoue souvent sur PDF (résumeur ne décode pas le binaire) -> solution: télécharger via WebFetch (le fichier binaire est sauvegardé automatiquement en local), puis pip install pymupdf et lire le texte directement en Python. Federal Register bloque WebFetch direct (redirect unblock) -> préférer les pages miroir NOAA (floridakeys.noaa.gov, fisheries.noaa.gov). opc.ca.gov bloque WebFetch (WAF) -> se contenter des extraits de recherche web.

12/12 WebSearch utilisées. ~13 WebFetch utilisées (libre). Rédaction du dossier.md en cours.
